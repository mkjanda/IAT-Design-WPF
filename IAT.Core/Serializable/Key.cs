...
namespace IAT.Core.Serializable
{
    ...
    {
        /// <summary>
        /// Gets the URI that identifies the location of the part within the package.
        /// </summary>
        /// <remarks>The returned URI is constructed based on the type of the key and the identifier. This
        /// property is typically used to reference the part in package-related operations.</remarks>
        [XmlIgnore]
        public Uri? Uri => PackUriHelper.CreatePartUri(new Uri($"{typeof(Key).ToString()}/{Id}.xml", UriKind.Relative));
