...
{
    public readonly record ElementFont(String Name, Type Type)
    {
        public static readonly ElementFont Stimulus = new _Stimulus();
        public static readonly ElementFont ContinueInstructions = new _ContinueInstructions();
        public static readonly ElementFont ResponseKey = new _ResponseKey();
        public static readonly ElementFont Conjunction = new _Conjunction();
        public static readonly ElementFont BlockInstructions = new _BlockInstructions();
        public static readonly ElementFont Instructions = new _TextInstructionsScreen();

        private sealed record _Stimulus() : ElementFont("Stimulus", typeof(DIStimulus));
        private sealed record _ContinueInstructions() : ElementFont("ContinueInstructions", typeof(DIContinueInstructions));
