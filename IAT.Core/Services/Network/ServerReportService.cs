...
/// </summary>
public class ServerReportService : IServerReportService
{
    ...
    public ServerReportService(IWebSocketService webSocketService, TransactionState transactionState)
    {
        ...
        _webSocketService.TransactionCommands[TransactionType.RequestTransmission] = (request) => new RequestTransmissionServerReportCommand(request);
    }
