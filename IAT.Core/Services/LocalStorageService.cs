...
namespace IAT.Core.Services
{
    ...
    public interface ILocalStorageService
    {
        ...
        /// <summary>
        /// Stores (or overwrites) the password for a deployed IAT under local AppData, encrypted at rest.
        /// Call after a successful deploy so subsequent Retrieve / Clear / Delete operations can auto-fill.
        /// </summary>
        /// <param name="iatName">Deployed IAT name.</param>
